...
import base.text.String._
import base.reflect.Extension._
import base.struct.MapField
import base.collection.BiMap
...
object TreeConvertible {
  ...
  implicit object NodeConvertible extends TreeConvertible[Node] {
    def apply(tree: ru.Tree): Node = {
      ...
      val tb = base.reflect.Extension.mirror.mkToolBox()
